...
<#--            <i class="iconfont icon-kiss" title="飞吻"></i><span style="color: #FF7200;">66666 飞吻</span>-->
        ...
        <p class="fly-home-sign">${user.sign!'站在巨人的肩膀上!'}</p>
    ...
    <div class="layui-container">
        <div class="layui-row layui-col-space15">
            <div class="layui-col-md6 fly-home-jie">
                <div class="fly-panel">
                    <h3 class="fly-panel-title">${user.username} 最近的博客</h3>
                    <ul class="jie-row">
                        <#if (posts?size>0)>
                        <#list posts as post>
                        <li>
                            ...
                            <i>${time(post.created)}</i>
                            <em class="layui-hide-xs">${post.viewCount}阅读/${post.commentCount}答</em>
                        </li>
                        </#list>
